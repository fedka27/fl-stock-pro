 ...
 */
public class SubscribeGCMRequest extends BaseRequest implements RequestWithNotifications {
    public SubscribeGCMRequest(Context context, Bundle bundle) {
        super(context, bundle);
    }

    @Override
    public ResponseHolder makeRequest() throws Exception {
        return Communicator.getAppServer().subscribeGCM(new RequestParams()
    ...
    public int getRequestName() {
        return R.string.request_subscribe_gcm;
    }
